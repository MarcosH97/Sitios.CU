...
class MainMinActivity : AppCompatActivity() {
    var cont : Int = 0
...
//            Toast.makeText(this, VERSION_NAME+" - "+lastVersion, Toast.LENGTH_SHORT ).show()
        ...
        btnx.setOnClickListener{
            val intentx = Intent(this@MainMinActivity, SettingsActivity::class.java)
...
//            Toast.makeText(this, preferences.getString("url3", ""), Toast.LENGTH_SHORT).show()
    ...
    fun addMod(i : Int, mode : Int){
        val intent = Intent(this@MainMinActivity, WebViewActivity::class.java)
        if(mode == 0){
...
//        return selected
    ...
    fun Arrows(){
        val arrows = arrayOf(findViewById(R.id.arrow0),
            ...
            findViewById<Button>(R.id.arrow4))
        ...
        for (i in arrows.indices){
            ...
            btn.setOnClickListener{
                val layoutParams = ly.layoutParams as LinearLayout.LayoutParams
    ...
    fun changeToDir(c :Context,name: String){
        ...
        val intent = Intent(this@MainMinActivity, ListMinActivity::class.java)
        intent.putExtras(bundle)
        startActivity(intent)
    }
...
//                            Toast.makeText(this, select.url, Toast.LENGTH_SHORT).show()
    ...
    fun MainButtons(){
        ...
        val c5 : ImageButton = findViewById(R.id.ppm_btn)
        val c6 : ImageButton = findViewById(R.id.rtv_btn)
        val c7 : ImageButton = findViewById(R.id.uni_btn)
        val c8 : ImageButton = findViewById(R.id.trade_btn)
...
//                Toast.makeText(this, filtered_names.size.toString(), Toast.LENGTH_SHORT).show()
